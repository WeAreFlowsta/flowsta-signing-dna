...
# Build script for Flowsta Signing DNA v1.2

set -e

echo "Building Flowsta Signing DNA v1.2"
...
echo ""
echo "Outputs:"
echo "  - DNA: workdir/flowsta_signing_v1_2.dna"
echo "  - hApp: workdir/flowsta_signing_v1_2_happ.happ"

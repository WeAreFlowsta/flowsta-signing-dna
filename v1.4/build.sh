...
# Build script for Flowsta Signing DNA v1.4

set -e

echo "Building Flowsta Signing DNA v1.4"
...
echo ""
echo "Outputs:"
echo "  - DNA: workdir/flowsta_signing_v1_4.dna"
echo "  - hApp: workdir/flowsta_signing_v1_4_happ.happ"
